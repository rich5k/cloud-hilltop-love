        ...
        <form action="../action/update_profile_process.php" class="form-horizontal" role="form" enct>
            ...
            <select id="major" class="form-select form-select-lg" name="major">
              <?php 
                foreach ($majors as $major){?>
                 <option value=<?php echo $major['course_id'];?> <?php if($major['course_id'] == $user['major']){echo("selected");} ?> id=<?php echo $major['course_id'] ?>><?php echo $major['course_title']?></option>
               <?php }
              ?>
            </select>
          </div>
          ...
          <div class='form-group'>
            ...
            <select name="sexual_orientation" id="sexual_orient" class="form-select form-select-lg">
              <option value="2" <?php if(2 == $user['sexual_orientation']){echo("selected");} ?> >Bisexual</option>
              <option value="1" <?php if(1 == $user['sexual_orientation']){echo("selected");} ?> >Heterosexual</option>
              
              <option value="3" <?php if(3 == $user['sexual_orientation']){echo("selected");} ?> >Homosexual</option>
              <option value="4" <?php if(4 == $user['sexual_orientation']){echo("selected");} ?> >Pansexual</option>
            </select>
