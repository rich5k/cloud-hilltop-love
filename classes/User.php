...
class User extends db_connection
{
    ...
    {
        return $this->db_query("INSERT INTO users(fname, lname, user_email, user_password, gender, twitter, instagram, class, sexual_orientation, dob, major, user_number, user_role)
    ...
    {
        return $this->db_fetch_one("SELECT Uid, user_email, user_password, user_role from users WHERE user_email = '$email'");
    }

    function findEmail($email)
    {
        return $this->db_fetch_one("SELECT user_email from users WHERE user_email = '$email'");
    }

    function findID($email)
    {
        return $this->db_fetch_one("SELECT Uid FROM users WHERE user_email = '$email'");
    }

    function addImage($image_1, $image_2, $image_3, $image_4, $image_5)
    {
        return $this->db_query("INSERT INTO pictures(image_1, image_2, image_3, image_4, image_5) values ('$image_1','$image_2','$image_3','$image_4','$image_5','')");
    }

    function updateImage($id, $image_1, $image_2, $image_3, $image_4, $image_5)
    {
